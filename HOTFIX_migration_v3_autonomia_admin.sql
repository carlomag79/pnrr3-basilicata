...
-- Queste funzioni esistevano già con un diverso tipo di ritorno.
-- PostgreSQL richiede DROP + CREATE, non CREATE OR REPLACE.
drop function if exists public.admin_list_legacy_claims(text);
